  ...
  <div>
    <CardUrbitavel>
      <form id="form" class="w-full flex flex-col items-center justify-center">
        <h1 class="text-5xl text-title font-medium mb-2">
        ...
        <div class="w-full flex flex-col space-y-2 mt-20">
          <label for="duvida" class="text-sm font-medium">Escreva sua mensagem ou dúvida:</label>
        ...
        <div class="w-full mt-14">
          <v-btn class="text-subtitle-1" color="#D9D9D9" size="small"  dark  @click.prevent="handleSubmit" ><span class="text-lilac">
              Inscrever-se         
            </span>
            <v-dialog 
              v-model="dialog"
